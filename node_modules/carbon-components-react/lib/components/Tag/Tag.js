...
var Tag = function Tag(_ref) {
  ...
  var tagClasses = (0, _classnames.default)("".concat(prefix, "--tag"), className, (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--tag--disabled"), disabled), (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--tag--filter"), filter), (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--tag--").concat(size), size), (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--tag--").concat(type), type), (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--tag--interactive"), other.onClick && !filter), _classNames));
  ...
  return /*#__PURE__*/_react.default.createElement(ComponentTag, (0, _extends2.default)({

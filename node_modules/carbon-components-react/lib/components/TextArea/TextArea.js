...
var _excluded = ["className", "id", "labelText", "hideLabel", "onChange", "onClick", "invalid", "invalidText", "helperText", "light", "placeholder"];
...
var TextArea = /*#__PURE__*/_react.default.forwardRef(function TextArea(_ref, ref) {
  ...
  var labelClasses = (0, _classnames.default)("".concat(prefix, "--label"), (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--visually-hidden"), hideLabel), (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--label--disabled"), other.disabled), _classNames));
  ...
  var textareaClasses = (0, _classnames.default)("".concat(prefix, "--text-area"), [enabled ? null : className], (_classNames3 = {}, (0, _defineProperty2.default)(_classNames3, "".concat(prefix, "--text-area--light"), light), (0, _defineProperty2.default)(_classNames3, "".concat(prefix, "--text-area--invalid"), invalid), _classNames3));

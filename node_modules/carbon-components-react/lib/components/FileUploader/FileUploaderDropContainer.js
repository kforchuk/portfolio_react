...
function FileUploaderDropContainer(_ref) {
  ...
  var labelClasses = (0, _classnames.default)("".concat(prefix, "--file-browse-btn"), (0, _defineProperty2.default)({}, "".concat(prefix, "--file-browse-btn--disabled"), disabled));
  var dropareaClasses = (0, _classnames.default)("".concat(prefix, "--file__drop-container"), (_classNames2 = {}, (0, _defineProperty2.default)(_classNames2, "".concat(prefix, "--file__drop-container--drag-over"), isActive), (0, _defineProperty2.default)(_classNames2, className, className), _classNames2));
  /**

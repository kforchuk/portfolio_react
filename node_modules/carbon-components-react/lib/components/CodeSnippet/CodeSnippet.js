...
function CodeSnippet(_ref) {
  ...
  var handleCopyClick = function handleCopyClick(evt) {
    (0, _copyToClipboard.default)(children);
  ...
  var codeSnippetClasses = (0, _classnames.default)(className, "".concat(prefix, "--snippet"), (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--snippet--").concat(type), type), (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--snippet--disabled"), type !== 'inline' && disabled), (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--snippet--expand"), expandedCode), (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--snippet--light"), light), (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--snippet--no-copy"), hideCopyButton), (0, _defineProperty2.default)(_classNames, "".concat(prefix, "--snippet--wraptext"), wrapText), _classNames));
  ...
  if (type === 'inline') {
    ...
    return /*#__PURE__*/_react.default.createElement(_Copy.default, (0, _extends2.default)({}, rest, {
  ...
  }, containerStyle), /*#__PURE__*/_react.default.createElement("pre", {
    ref: codeContentRef,
    onScroll: type === 'multi' && handleScroll || null
  }, /*#__PURE__*/_react.default.createElement("code", null, children))), hasLeftOverflow && /*#__PURE__*/_react.default.createElement("div", {
...
CodeSnippet.propTypes = {
   ...
   */
  maxCollapsedNumberOfRows: _propTypes.default.number,

  /**
   * Specify the maximum number of rows to be shown when in expanded view
   */
  maxExpandedNumberOfRows: _propTypes.default.number,

  /**
   * Specify the minimum number of rows to be shown when in collapsed view
   */
  minCollapsedNumberOfRows: _propTypes.default.number,

  /**
   * Specify the minimum number of rows to be shown when in expanded view
   */
  minExpandedNumberOfRows: _propTypes.default.number,

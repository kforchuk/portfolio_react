...
describe('Pagination', function () {
  describe('renders as expected', function () {
    var pagination = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Pagination.default, {
      className: "extra-class",
      pageSizes: [5, 10],
      totalItems: 50
    }));
    describe('icons', function () {
      var iconTypes = [_iconsReact.CaretLeft16, _iconsReact.CaretRight16];
    ...
    describe('pagination container', function () {
      it('should render the expected classes', function () {
        expect(pagination.childAt(0).hasClass("".concat(prefix, "--pagination"))).toBe(true);
    ...
    describe('pagination paging container', function () {
      ...
      it('should have two buttons for navigation', function () {
        var buttons = right.find(".".concat(prefix, "--pagination__button")).hostNodes();
      ...
      describe('pagination paging container when total pages unknown', function () {
        ...
        it('should append `pagination__button--no-index` class if input is disabled', function () {
          ...
          expect(backwardButton.hasClass("".concat(prefix, "--pagination__button--no-index"))).toEqual(true);
          expect(forwardButton.hasClass("".concat(prefix, "--pagination__button--no-index"))).toEqual(true);
        });
      });
      describe('pagination navigation', function () {
        it('should go to the next page when clicking forward', function () {
          ...
          expect(pager.state().page).toBe(1);
          pager.find(".".concat(prefix, "--pagination__button--forward")).hostNodes().simulate('click');
        ...
        it('should go to the previous page when clicking backward', function () {
          ...
          expect(pager.state().page).toBe(2);
          pager.find(".".concat(prefix, "--pagination__button--backward")).hostNodes().simulate('click');
          expect(actualPage).toBe(1);
          expect(pager.state().page).toBe(1);
        });

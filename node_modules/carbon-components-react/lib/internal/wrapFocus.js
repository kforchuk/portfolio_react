...
function elementOrParentIsFloatingMenu(node) {
  ...
  if (node && typeof node.closest === 'function') {
    var allSelectorsFloatingMenus = [".".concat(prefix, "--overflow-menu-options"), ".".concat(prefix, "--tooltip"), '.flatpickr-calendar'].concat((0, _toConsumableArray2.default)(selectorsFloatingMenus));

...
export var WithStateManager = function WithStateManager() {
  ...
  return /*#__PURE__*/React.createElement(ModalStateManager, {
    ...
    return /*#__PURE__*/React.createElement(Modal, {
    ...
    }, "Custom domains direct requests for your apps in this Cloud Foundry organization to a URL that you own. A custom domain can be a shared domain, a shared subdomain, or a shared domain and host.", /*#__PURE__*/React.createElement(Tooltip, {
      ...
      size: "small"
    }, "Create")))), /*#__PURE__*/React.createElement(TextInput, {
      "data-modal-primary-focus": true,
      id: "text-input-1",
      labelText: "Domain name",
      placeholder: "e.g. github.com",

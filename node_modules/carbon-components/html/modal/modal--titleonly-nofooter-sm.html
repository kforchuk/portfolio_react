...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-adeiorw0p5n">Show
  modal</button>

<div data-modal id="modal-adeiorw0p5n" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-adeiorw0p5n-label" aria-describedby="modal-adeiorw0p5n-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-adeiorw0p5n-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-adeiorw0p5n-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>

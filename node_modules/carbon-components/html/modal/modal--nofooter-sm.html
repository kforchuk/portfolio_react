...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ty3izyp5iv">Show
  modal</button>

<div data-modal id="modal-ty3izyp5iv" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ty3izyp5iv-label" aria-describedby="modal-ty3izyp5iv-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ty3izyp5iv-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ty3izyp5iv-heading">Modal heading</p>

...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-jmk66wsbah">Show
  modal</button>

<div data-modal id="modal-jmk66wsbah" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-jmk66wsbah-label" aria-describedby="modal-jmk66wsbah-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jmk66wsbah-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jmk66wsbah-heading">Modal heading</p>

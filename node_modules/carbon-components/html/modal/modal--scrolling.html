...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-b2olikeq44c">Show
  modal</button>

<div data-modal id="modal-b2olikeq44c" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-b2olikeq44c-label" aria-describedby="modal-b2olikeq44c-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-b2olikeq44c-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-b2olikeq44c-heading">Modal heading</p>

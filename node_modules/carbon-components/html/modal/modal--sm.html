...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-yv469krmdi">Show
  modal</button>

<div data-modal id="modal-yv469krmdi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-yv469krmdi-label" aria-describedby="modal-yv469krmdi-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-yv469krmdi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-yv469krmdi-heading">Modal heading</p>

...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-plo3uzkr6pm">Show
  modal</button>

<div data-modal id="modal-plo3uzkr6pm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-plo3uzkr6pm-label" aria-describedby="modal-plo3uzkr6pm-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-plo3uzkr6pm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-plo3uzkr6pm-heading">Modal heading</p>

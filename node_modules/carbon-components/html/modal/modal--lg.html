...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-hpahxgb7d4">Show
  modal</button>

<div data-modal id="modal-hpahxgb7d4" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-hpahxgb7d4-label" aria-describedby="modal-hpahxgb7d4-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-hpahxgb7d4-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-hpahxgb7d4-heading">Modal heading</p>

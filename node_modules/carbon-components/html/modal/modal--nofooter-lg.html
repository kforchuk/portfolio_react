...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-bockyw36fh">Show
  modal</button>

<div data-modal id="modal-bockyw36fh" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-bockyw36fh-label" aria-describedby="modal-bockyw36fh-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-bockyw36fh-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-bockyw36fh-heading">Modal heading</p>

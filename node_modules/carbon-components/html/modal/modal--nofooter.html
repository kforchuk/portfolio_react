...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-eyxs5ndhxjj">Show
  modal</button>

<div data-modal id="modal-eyxs5ndhxjj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-eyxs5ndhxjj-label" aria-describedby="modal-eyxs5ndhxjj-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-eyxs5ndhxjj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-eyxs5ndhxjj-heading">Modal heading</p>

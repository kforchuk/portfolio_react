...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-hdclu557hh">Show
  modal</button>

<div data-modal id="modal-hdclu557hh" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-hdclu557hh-label" aria-describedby="modal-hdclu557hh-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-hdclu557hh-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-hdclu557hh-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-hdclu557hh" class="bx--label">Text Input label</label>
        <input id="text-input-hdclu557hh" type="text" class="bx--text-input" placeholder="Optional placeholder text"

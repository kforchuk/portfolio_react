...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-dx05l9fgjjw">Show
  modal</button>

<div data-modal id="modal-dx05l9fgjjw" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-dx05l9fgjjw-label" aria-describedby="modal-dx05l9fgjjw-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-dx05l9fgjjw-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-dx05l9fgjjw-heading">Modal heading</p>
